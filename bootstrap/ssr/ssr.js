...
createServer(
  (page) => createInertiaApp({
    ...
    title: (title) => title + " - Luniasola®" || "Luniasola®",
    resolve: (name) => resolvePageComponent("./pages/" + name + ".tsx", /* @__PURE__ */ Object.assign({ "./pages/auth/confirm-password.tsx": () => import("./assets/confirm-password-fqRAuTRa.js"), "./pages/auth/forgot-password.tsx": () => import("./assets/forgot-password-N11jvbXE.js"), "./pages/auth/login.tsx": () => import("./assets/login-Cr-DQiDP.js"), "./pages/auth/register.tsx": () => import("./assets/register-Dbid4Ev1.js"), "./pages/auth/reset-password.tsx": () => import("./assets/reset-password-CU6Cp2Vt.js"), "./pages/auth/verify-email.tsx": () => import("./assets/verify-email-DqCncAhY.js"), "./pages/dashboard.tsx": () => import("./assets/dashboard-BApdfpnz.js"), "./pages/settings/appearance.tsx": () => import("./assets/appearance-CSnXz9Uh.js"), "./pages/settings/password.tsx": () => import("./assets/password-DxvsB5c9.js"), "./pages/settings/profile.tsx": () => import("./assets/profile-D3F_YMF2.js"), "./pages/welcome.tsx": () => import("./assets/welcome-2JObkd8G.js") })),
    setup: ({ App, props }) => {
